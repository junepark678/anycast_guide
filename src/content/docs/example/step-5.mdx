...
// Reverse zone for your anycast prefix (optional)
...
zone "example.com" {
    type master;
    file "/etc/bind/zones/db.example.com";
    allow-transfer { 192.0.2.20; 192.0.2.30; };  // Secondary IPs
    notify yes;
};
...
dig @203.0.113.1 example.com SOA +norecurse
```
...
ripe-atlas measure dns --query-argument example.com --query-type A --target 203.0.113.1
```

## Verification Checklist

- [ ] BIND listening on anycast IP (both IPv4 and IPv6)
