...
router bgp 65001
 ...
 neighbor 169.254.169.254 remote-as 64512
 neighbor 169.254.169.254 password your-bgp-password
 ...
 address-family ipv4 unicast
  ...
  neighbor 169.254.169.254 route-map IMPORT in
 exit-address-family
!
```
...
2. **View detailed neighbor information**
   ```bash
   sudo vtysh -c "show bgp neighbors 169.254.169.254"
   ```

3. **Verify advertised routes**
   ```bash
   sudo vtysh -c "show bgp ipv4 unicast neighbors 169.254.169.254 advertised-routes"
   ```
